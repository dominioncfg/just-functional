...
namespace JustFunctional.Core
{
    public class SquareRootOperator : Operator
    {
        ...
        public override decimal Calculate(List<Operand> operands, IEvaluationContext context) => (decimal)Math.Sqrt((double)ResolveIfVariableOperand(operands[0], context));
    }
}