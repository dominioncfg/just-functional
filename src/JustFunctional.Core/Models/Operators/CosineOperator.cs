...
namespace JustFunctional.Core
{
    public class CosineOperator : Operator
    {
        ...
        public override decimal Calculate(List<Operand> operands, IEvaluationContext context) => (decimal)Math.Cos((double)ResolveIfVariableOperand(operands[0], context));
    }
}